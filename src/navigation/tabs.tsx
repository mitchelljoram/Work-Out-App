...
export const TabNavigator = () => {
    return (
      <Tab.Navigator tabBarPosition="bottom" screenOptions={{ tabBarStyle: { backgroundColor: "#141414" }, tabBarAndroidRipple: { borderless: false }, tabBarIndicatorStyle: { backgroundColor: "white", }}}>
