...
export const TabNavigator = () => {
    return (
      <Tab.Navigator tabBarPosition="bottom" screenOptions={{ tabBarStyle: { backgroundColor: "#1F1F1F" }, tabBarAndroidRipple: { borderless: false }, tabBarIndicatorStyle: { backgroundColor: "white", }}}>
